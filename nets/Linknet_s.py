...
def decoder_block(input_tensor, m, n):
    ...
    x = Conv2DTranspose(filters=int(m/4), kernel_size=(2, 2), strides=(2,2), padding='same')(x)
    x = BatchNormalization()(x)
    x = Activation('relu')(x)
...
class Linknet_s(myNet):
    ...
    #
        ...
        x = Conv2DTranspose(filters=32, kernel_size=(2, 2), strides=(2,2), padding='same')(decoder_1)
        x = BatchNormalization()(x)
        x = Activation('relu')(x)
        ...
        x = Conv2DTranspose(filters=32, kernel_size=(2, 2), strides=(2,2), padding='same')(x)
        x = BatchNormalization()(x)
        x = Activation('relu')(x)
